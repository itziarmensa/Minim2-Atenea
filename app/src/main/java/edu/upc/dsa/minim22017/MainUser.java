...
import edu.upc.dsa.minim22017.adapter.AdapterDatos;
...
public class MainUser extends AppCompatActivity {
    ...
    public void getInfo(){
        ...
        Call<List<Repositories>> call = service.getRepositories(preferencias.getString("username",""));
        ...
        call.enqueue(new Callback<List<Repositories>>() {
            ...
            public void onResponse(Call<List<Repositories>> call, Response<List<Repositories>> response) {
                List<Repositories> lista = response.body();
